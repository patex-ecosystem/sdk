...
import { getContractInterface } from '@eth-patex/contracts-bedrock'
import { hexStringEquals } from '@eth-patex/core-utils'
...
export class StandardBridgeAdapter implements IBridgeAdapter {
  ...
  public async supportsTokenPair(
    ...
    try {
      const contract = new Contract(
        toAddress(l2Token),
        getContractInterface('PatexMintableERC20'),
        this.messenger.l2Provider
      )
  ...
  public async approval(
    ...
    const token = new Contract(
      toAddress(l1Token),
      getContractInterface('PatexMintableERC20'), // Any ERC20 will do
      this.messenger.l1Provider
    )
