...
import { predeploys, getContractInterface } from '@eth-patex/contracts'
...
/**
 * Returns an provider wrapped as an Patex L2 provider. Adds a few extra helper functions to
 * simplify the process of estimating the gas usage for a transaction on Patex. Returns a COPY
...
export const asL2Provider = <TProvider extends Provider>(
  ...
  // Modify the block formatter to return the state root. Not strictly related to Patex, just a
